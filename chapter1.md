# <a name="1-The-way-of-program"></a> 第一章 编程方式
...
_练习 1.4_ ：运行 Python 解释器, 并把他当作计算器使用. Python 数学运算的语法与数学符号很类似. 例如, "+", "-" 和 "/" 分别表示加, 减和除. 如你所期待, "*" 表示乘法.
如果你用了43分钟30秒完成了10千米比赛, 每英里的平均时间是多少? 每小时的平均跑了多少英里? (提示: 1.61 千米 = 1 英里)